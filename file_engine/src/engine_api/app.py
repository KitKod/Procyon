...
from engine_api import endpoints
from engine_api.configs import Configs
from engine_api.constants import (
    PROJECT_NAME,
    API_PREFIX,
    SWAGGER_DOC_ENDPOINT,
    DESCRIPTION,
)
from engine_api.containers import Application
...
def run_application():
    ...
    uvicorn.run("engine_api.app:create_application", **options)
